...
export class EmpleadoController {
  ...
  @Patch(':id') @Roles('ADMINISTRADOR') @ApiOperation({ summary: 'Actualizar empleado' })
  update(@Param('id') id: string, @CurrentUser('idEmpresa') idEmpresa: string, @Body() dto: UpdateEmpleadoDto) { return this.service.update(id, idEmpresa, dto); }
